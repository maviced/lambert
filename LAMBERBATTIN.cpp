...
void LAMBERTBATTIN(double ro[], double r[], char dm[], double Dtsec, double vo[], double v[])
{
	...
	double small, mu, y1, magr, magro, CosDeltaNu, rcrossr[3], magrcrossr, SinDeltaNu, DNu, RoR, eps, tan2w, rp, L, m, x, xn, 
	chord, s, lim1, tempx, Denom, h1, h2, u, k2, y, b, a, arg1, arg2, AlpH, BetH, DH, F, GDot, G, Sinv, Cosv, BetE, am, ae, be, tm, AlpE, DE;
	int i, Loops;
	...
	rp    = sqrt( magro*magr )*( (cos(DNu*0.25))*(cos(DNu*0.25)) + tan2w );
